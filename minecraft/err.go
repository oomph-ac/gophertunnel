...
// ErrBufferedSendLimit is returned when buffering another packet would exceed
// the packet or byte limit configured with Conn.SetBufferedSendLimits.
var ErrBufferedSendLimit = errors.New("buffered send limit exceeded")
